const CACHE='anesvet-v14-4-patient-integrity';
const ASSETS=['./','./index.html','./style.css?v=14.4','./app.js?v=14.4','./manifest.webmanifest','./icon-192.png','./icon-512.png','./icon-maskable-512.png'];
