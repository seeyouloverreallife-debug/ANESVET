const CACHE='anesvet-v14-5-clinical-ux';
const ASSETS=['./','./index.html','./style.css?v=14.5','./app.js?v=14.5','./manifest.webmanifest','./icon-192.png','./icon-512.png','./icon-maskable-512.png'];
