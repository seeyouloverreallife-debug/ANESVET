const CACHE='anesvet-v13-3-status';
const ASSETS=['./','./index.html','./style.css?v=13.3','./app.js?v=13.3','./manifest.webmanifest','./icon-192.png','./icon-512.png','./icon-maskable-512.png'];
