const CACHE='anesvet-v14-hardening';
const ASSETS=['./','./index.html','./style.css?v=14','./app.js?v=14','./manifest.webmanifest','./icon-192.png','./icon-512.png','./icon-maskable-512.png'];
