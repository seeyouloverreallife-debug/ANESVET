const CACHE='anesvet-v15-10-2-briefing-or-transition-hotfix';
const ASSETS=['./','./index.html','./style.css?v=15.10.2','./clinical-workflow.js?v=15.10.2','./app.js?v=15.10.2','./manifest.webmanifest','./icon-192.png','./icon-512.png','./icon-maskable-512.png'];
