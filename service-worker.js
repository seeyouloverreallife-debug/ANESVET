const CACHE='anesvet-v13-4-alerts';
const ASSETS=['./','./index.html','./style.css?v=13.4','./app.js?v=13.4','./manifest.webmanifest','./icon-192.png','./icon-512.png','./icon-maskable-512.png'];
