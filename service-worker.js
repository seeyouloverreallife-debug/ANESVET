const CACHE='anesvet-v11-1-hotfix2';
const ASSETS=['./','./index.html','./style.css?v=11.1','./app.js?v=11.1','./manifest.webmanifest','./icon-192.png','./icon-512.png','./icon-maskable-512.png'];
