const CACHE='anesvet-v14-6-3-current-bw-fix';
const ASSETS=['./','./index.html','./style.css?v=14.6.3','./app.js?v=14.6.3','./manifest.webmanifest','./icon-192.png','./icon-512.png','./icon-maskable-512.png'];
