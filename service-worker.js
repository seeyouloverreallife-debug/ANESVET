const CACHE='anesvet-v13-2-recovery';
const ASSETS=['./','./index.html','./style.css?v=13.2','./app.js?v=13.2','./manifest.webmanifest','./icon-192.png','./icon-512.png','./icon-maskable-512.png'];
