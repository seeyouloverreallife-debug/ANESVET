const CACHE='anesvet-v14-3-patient-master';
const ASSETS=['./','./index.html','./style.css?v=14.3','./app.js?v=14.3','./manifest.webmanifest','./icon-192.png','./icon-512.png','./icon-maskable-512.png'];
