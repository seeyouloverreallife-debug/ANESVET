const CACHE='anesvet-v12-2-icon';
const ASSETS=['./','./index.html','./style.css?v=12.1','./app.js?v=12.1','./manifest.webmanifest','./icon-192.png','./icon-512.png','./icon-maskable-512.png'];
