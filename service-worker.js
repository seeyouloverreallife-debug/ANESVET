const CACHE='anesvet-v15-10-1-pre-or-briefing-hotfix';
const ASSETS=['./','./index.html','./style.css?v=15.10.1','./clinical-workflow.js?v=15.10.1','./app.js?v=15.10.1','./manifest.webmanifest','./icon-192.png','./icon-512.png','./icon-maskable-512.png'];
