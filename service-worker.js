const CACHE='anesvet-v14-3-1-safety-hotfix';
const ASSETS=['./','./index.html','./style.css?v=14.3.1','./app.js?v=14.3.1','./manifest.webmanifest','./icon-192.png','./icon-512.png','./icon-maskable-512.png'];
