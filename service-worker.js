const CACHE='anesvet-v6-1-hotfix';
const ASSETS=['./','./index.html','./style.css?v=6.1','./app.js?v=6.1','./manifest.webmanifest','./icon-192.png','./icon-512.png','./icon-maskable-512.png'];
