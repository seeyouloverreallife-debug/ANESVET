const CACHE='anesvet-v13-1-safety';
const ASSETS=['./','./index.html','./style.css?v=13.1','./app.js?v=13.1','./manifest.webmanifest','./icon-192.png','./icon-512.png','./icon-maskable-512.png'];
