...
function loadSettings(){
  ...
  renderProtocolGovernance();renderOrWorkspacePreferences();renderDefaultReportPreference();window.AnesvetBranding?.loadForm?.();window.AnesvetBranding?.renderAppHeader?.();
}
